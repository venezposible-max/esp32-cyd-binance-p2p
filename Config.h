...
const unsigned long FETCH_INTERVAL_AWAKE_MS = 25000; // 25 seg: Pantalla activa despierta
const unsigned long FETCH_INTERVAL_SLEEP_MS = 90000; // 90 seg: Modo salvapantallas (reposo ultra ahorrativo)
